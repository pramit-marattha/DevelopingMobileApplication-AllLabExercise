...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            QuizDatabase dbHelper = QuizDatabase.getInstance(this);
    ...
    private void checkAnswer() {
        ...
        if (answerNr == currentQuestion.getAnswerNumber()) {
            score++;
            textViewScore.setText("Total Points Earned: " + score);
        }
    ...
    private void showSolution() {
        ...
        switch (currentQuestion.getAnswerNumber()) {
            case 1:
                ...
                textViewQuestion.setText("Option '1' is correct choice");
                break;
            case 2:
                rb2.setTextColor(Color.GREEN);
                textViewQuestion.setText("Option '2' is correct choice");
                break;
            case 3:
                rb3.setTextColor(Color.GREEN);
                textViewQuestion.setText("Option '3' is correct choice");
                break;
        }

        if (questionCounter < questionCountTotal) {
            buttonConfirmNext.setText("Another One!");
        } else {
